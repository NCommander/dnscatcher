...
package DNS_Sender_Interface_IPv4_UDP is
   ...
   task type Send_Packet_Task is
      entry Initialize (Config : Configuration_Ptr; Socket : Socket_Type; Transaction_Manager : DNS_Transaction_Manager_Task_Ptr; Packet_Queue: Raw_DNS_Packets.Raw_DNS_Packet_Queue_Ptr);
      entry Start;
      entry Stop;
   ...
   function Get_Packet_Queue_Ptr(This: in out IPv4_UDP_Sender_Interface) return Raw_DNS_Packet_Queue_Ptr;
