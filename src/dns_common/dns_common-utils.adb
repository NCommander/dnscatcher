...
package body DNS_Common.Utils is
   ...
   is
      procedure Internal (Family : C.int; Src : System.Address; Dst : System.Address; Len : C.int);
   ...
   begin
      ...
      Internal(C.int(Family'Enum_Rep), To_String(Raw_Data)'Address, C_IP_String'Address, 15);
