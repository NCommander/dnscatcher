...
package DNS_RData_Processor.Domain_Name_Response_Parser is
   ...
   procedure From_Parsed_RR (This : in out Parsed_DNR_RData; Parsed_RR : Parsed_DNS_Resource_Record);
   function RData_To_String (This : in Parsed_DNR_RData) return String;
   function RClass_To_String (This : in Parsed_DNR_RData) return String;
   function Print_Packet (This : in Parsed_DNR_RData) return String;
