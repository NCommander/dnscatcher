...
package DNS_RData_Processor is
   ...
   function To_Parsed_RData(Parsed_RR: DNS_Packet_Processor.Parsed_DNS_Resource_Record) return Parsed_RData_Access;

   -- Represents RData in a string like fashion
   procedure From_Parsed_RR(This: in out Parsed_RData; Parsed_RR: DNS_Packet_Processor.Parsed_DNS_Resource_Record) is abstract;
