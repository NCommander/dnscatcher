...
package DNS_Core_Constructs is
   ...
   type RR_Types is
     (A,
      ...
      TA,
      DLV);
   for RR_Types use (A => 1, NS => 2, MD => 3, MF => 4, CNAME => 5, SOA => 6,
      MB => 7, MG => 8, MR => 9, DNS_NULL => 10, WKS => 11, PTR => 12,
      ...
      EID => 31, NIMLOC => 32, SRV => 33, ATMA => 34, NAPTR => 35, KX => 36,
      CERT => 37, A6 => 38, DNAME => 39, SINK => 40, OPT => 41, APL => 42,
      DS => 43, SSHFP => 44, IPSECKEY => 45, RRSIG => 46, NSEC => 47,
      DNSKEY => 48, DHCID => 49, NSEC3 => 50, NSEC3PARAM => 51, TLSA => 52,
      SMIMEA           => 53, HIP => 55, NINFO => 56, RKEY => 57, TALINK => 58,
      CDS => 59, CDNSKEY => 60, OPENPGPKEY => 61, CSYNC => 62, SPF => 99,
      UINFO => 100, UID => 101, GID => 102, UNSPEC => 103, NID => 104,
      L32 => 105, L64 => 106, LP => 107, EUI48 => 108, EUI64 => 109,
      TKEY => 249, TSIG => 250, IXFR => 251, AXFR => 252, MAILB => 253,
      MAILA => 254, WILDCARD => 255, URI => 256, CAA => 257, AVC => 258,
      DOA              => 259, TA => 32768, DLV => 32769);
   ...
   type Classes is
     (INternet, -- IN (IN is an Ada keyword, we'll have to handle this specially)
      ...
      QCLASS_NONE,
      QCLASS_ANY);
   for Classes use (INternet => 1, CH => 3, HS => 4, QCLASS_NONE => 254,
      QCLASS_ANY             => 255);
   ...
   type RCodes is
     (NoError,
      ...
      BADTRUNC,
      BADCOOKIE);
   for RCodes use (NoError => 0, FormErr => 1, ServFail => 2, NXDomain => 3,
      NotImp => 4, Refused => 5, YXDomain => 6, YXRRSet => 7, NXRRSet => 8,
      NotAuth => 9, NotZone => 10, BADSIG => 16, BADKEY => 17, BADTIME => 18,
