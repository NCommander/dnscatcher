...
package Packet_Parser is
   ...
   package Resource_Record_Vector is new Vectors (Natural, Raw_DNS_Packets.Raw_DNS_Resource_Record);
   ...
   procedure Parse_Question_Record(Raw_Data: Raw_DNS_Packet_Data; Offset: in out Stream_Element_Offset);
